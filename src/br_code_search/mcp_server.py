        ...
        "inputSchema": object_schema(
            {
                ...
                "ar_version": {"type": "string", "minLength": 1, "description": "Automation Runtime version substring."},
                "cpu_model": {"type": "string", "minLength": 1, "description": "CPU/module model substring."},
